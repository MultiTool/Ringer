...
#define DoRinger 0
  ...
  static const int ClipLow = -1024, ClipHigh = +1024;
  static const int ClipRange = ClipHigh - ClipLow;
...
public:
  ...
  /* **************************************************************************** */
  static double Sigmoid(double run) {
    double rise;
    rise = run / std::sqrt(1.0 + run * run);
    return rise;
  }
  /* **************************************************************************** */
  static double InvSigmoid(double run) {
  ...
  /* **************************************************************************** */
  static double CurveMap(double Min, double Ctr, double Max) {// make random numbers in a normal distribution
  ...
  static int rand(unsigned int range){
    return rand()%range;
  }
};
#if false
